...
- OpenCC `s2t.json`轉換`abbrev.txt`, `chengyu.txt`, `chinese_english.txt`, `emoji.txt`, `english_chinese.txt`, `others.txt`, `t9_abbrev.txt`, `tips_show.txt`, `number_translator.lua`, `shijian.lua`, `wanxiang_symbols.yaml`
